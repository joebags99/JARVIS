...
# The monarchmoney PyPI package still points to the old domain. Monarch migrated
# to api.monarch.com; patch it here until a fixed release lands on PyPI.
...
async def _get_client():
    ...
    try:
        ...
        raise RuntimeError(
            "Monarch Money requires MFA. Disable 2FA in Monarch → Settings → "
